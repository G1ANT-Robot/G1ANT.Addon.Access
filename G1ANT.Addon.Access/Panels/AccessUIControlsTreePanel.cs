...
using G1ANT.Addon.Access.Controllers;
...
namespace G1ANT.Addon.Access.Panels
{
    [Panel(Name = "Access forms and controls tree", DockingSide = DockingSide.Right, InitialAppear = false, Width = 400,
        Description = "Panel with Access forms and controls tree. Also displays details of app, reports, recorsets, macros, modules, tables, indexes, query definitions and database diagrams")]
