...
namespace G1ANT.Addon.Access.Commands.Access.Data.Tables
{
    ...
    public class AccessOpenTableCommand : Command
    {
        ...
        {
            [Argument(Tooltip = "Name of the table to open", Required = true)]
            ...
            [Argument(Tooltip = "True to create new table. False by default")]
            public BooleanStructure CreateNew { get; set; } = new BooleanStructure(false);
        }

        public AccessOpenTableCommand(AbstractScripter scripter) : base(scripter)
        { }

        public void Execute(Arguments arguments)
        {
            AccessManager.CurrentAccess.OpenTable(arguments.Name.Value, arguments.ViewType.Value, arguments.CreateNew.Value, arguments.Readonly.Value);
        }
    }
}