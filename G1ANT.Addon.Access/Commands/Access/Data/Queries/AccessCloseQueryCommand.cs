...
namespace G1ANT.Addon.Access.Commands.Access.Data.Queries
{
    ...
    public class AccesCloseQueryCommand : Command
    {
        ...
        public AccesCloseQueryCommand(AbstractScripter scripter) : base(scripter)
        { }

        public void Execute(Arguments arguments)
        {
            AccessManager.CurrentAccess.Close(Microsoft.Office.Interop.Access.AcObjectType.acQuery, arguments.Name.Value, arguments.SaveChanges?.Value);
        }
    }
}