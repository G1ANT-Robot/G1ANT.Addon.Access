...
namespace G1ANT.Addon.Access.Commands.Access.Controls.Properties
{
    [Command(Name = "access.setcontrolproperty", Tooltip = "Set value of property of control of form of Access application")]
    public class AccessSetControlPropertyCommand : Command
    {
        ...
        public AccessSetControlPropertyCommand(AbstractScripter scripter) : base(scripter)
        { }

        public void Execute(Arguments arguments)
        {
            var control = AccessManager.CurrentAccess.GetControlByPath(arguments.Path.Value);
            control.SetPropertyValue(arguments.NameOfProperty.Value, arguments.Value.Value);
