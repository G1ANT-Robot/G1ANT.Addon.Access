...
namespace G1ANT.Addon.Access.Commands.Access.Forms.Properties
{
    [Command(Name = "access.setformproperty", Tooltip = "Set value of property of form of Access application")]
    public class AccessSetFormPropertyCommand : Command
    {
        ...
        public AccessSetFormPropertyCommand(AbstractScripter scripter) : base(scripter)
        { }

        public void Execute(Arguments arguments)
        {
            var form = AccessManager.CurrentAccess.GetForm(arguments.Name.Value);
            form.SetPropertyValue(arguments.NameOfProperty.Value, arguments.Value.Value);
        }
    }
}